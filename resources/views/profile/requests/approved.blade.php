...
@section('title', $user->name." || Approved Requests || ")
          ...
          @include('profile.sidebar')
            ...
            <div class="tabs-wrapper"> 
                <ul class="nav classic-tabs tabs-blue" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link waves-light" href="{{ route('requests.index') }}">Added Requests</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link waves-light active" data-toggle="tab" href="#accpetedRequests" role="tab">Approved Requests</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="tab-content card">
              <!--Panel 1-->
              <div class="tab-pane fade in show active" id="accpetedRequests" role="tabpanel">
