    ...
    <div class="container">
      ...
      <div class="bc-icons">
        ...
        <div class="row">
          ...
          <!-- Sidebar Column -->
          @include('profile.messages.sidebar')
            ...
            <div class="col-lg-10 mb-4">
                ...
                {!! Form::open(['route' => ['offers.destroy', $offer->id], 'method'=>'delete']) !!}
                    ...
                    <a href="{{ route('messages.offer', $offer->id) }}" class="btn btn-blue btn-sm" target="_blank"><i class="fa fa-external-link fa-sm pr-2"" aria-hidden="true"></i>View Messages</a>
