        ...
        <div class="row">
          ...
          @include('profile.sidebar')
            ...
            <div class="col-lg-10 mb-4">
                ...
                @if(empty($search))
                    <a class="btn btn-md blue-gradient mb-4" href="{{ route('orders.create') }}"><i class="fa fa-plus fa-sm pr-2"" aria-hidden="true"></i> Add Order</a>
                @else
                    <a class="btn btn-sm btn-blue" href="{{ route('orders.index') }}"><i class="fa fa-refresh fa-sm pr-2"" aria-hidden="true"></i> Refresh List</a>
                @endif
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-12 col-sm-12 col-xs-12">
                        {!! Form::open(['route' => ['orders.destroy', $order->id], 'method'=>'delete']) !!}
                          ...
                          {!! Form::button('<i class="fa fa-trash fa-sm pr-2"" aria-hidden="true"></i>Delete</a>', array('class' => 'btn btn-unique btn-sm form_warning_sweet_alert', 'title'=>'Are you sure?', 'text'=>'Your order will disapper!', 'confirmButtonText'=>'Yes, delete order!', 'type'=>'submit')) !!}
                        {!! Form::close() !!}
                    </div>
                    <!--Grid column-->
