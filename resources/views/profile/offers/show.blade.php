          ...
          @include('profile.sidebar')
            ...
            <div class="col-lg-10 mb-4">
                ...
                {!! Form::open(['route' => ['offers.destroy', $offer->id], 'method'=>'delete']) !!}
                    ...
                    <a href="{{ route('messages.show', $offer->message_subject_id) }}" class="btn btn-blue btn-sm" target="_blank"><i class="fa fa-comments fa-sm pr-2"" aria-hidden="true"></i>Offer Conversation</a>
                    ...
                    {!! Form::button('<i class="fa fa-trash fa-sm pr-2"" aria-hidden="true"></i>Delete', array('class' => 'btn btn-unique btn-sm form_warning_sweet_alert', 'title'=>'Are you sure?', 'text'=>'Your offer will disappear!', 'confirmButtonText'=>'Yes, delete offer!', 'type'=>'submit')) !!}
                {!! Form::close() !!}
