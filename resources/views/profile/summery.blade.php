          ...
          <div class="col-lg-10 mb-4">
            ...
            <div class="tabs-wrapper"> 
                <ul class="nav classic-tabs tabs-blue" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link waves-light active" data-toggle="tab" href="#panel51" role="tab">Summery</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link waves-light" data-toggle="tab" href="#panel52" role="tab">User Information</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link waves-light" data-toggle="tab" href="#panel53" role="tab">Update User Information</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="tab-content card">
                ...
                <div class="tab-pane fade" id="panel53" role="tabpanel">
                  ...
                  {!! Form::open(['method' => 'put', 'route' => ['update.information', $user->id]]) !!}
